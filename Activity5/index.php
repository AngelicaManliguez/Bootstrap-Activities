...
<html>
  ...
  <body>
    <h1 class="text-center text-uppercase" >Activity 5</h1>
    ...
    <div class="container">
      ...
      <ul class="list-inline">
        ...
        <li><a href="#" data-toggle="popover" data-placement="right" title="Right Popover" data-trigger="focus" data-content="Some content here in popover">Right</a></li>
      </ul>
      ...
      <div id="mycarousel" class="carousel slide" data-ride="carousel" style="width: 1000px">
        ...
        <div class="carousel-inner">
          <div class="item active">
            <img src="https://www.allkpop.com/upload/2021/06/content/102208/1623377298-1080full-yoon-jung-go.jpg" width="1000px">
          ...
          <div class="item">
            <img src="https://0.soompi.io/wp-content/uploads/2022/11/14214327/315744021_697255915104214_7596711607242992749_n.jpg" width="1000px">
            <div class="carousel-caption">
              <h3>My Second Pic</h1>
          ...
          <div class="item">
            <img src="https://6.soompi.io/wp-content/uploads/image/f62fc7fb05ed48e095525ffb86a97b4f/dummy.jpeg?s=900x600&e=t" width="1000px">
            <div class="carousel-caption">
              <h3>My Third Pic</h1>
